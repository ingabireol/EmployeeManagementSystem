...
public class EmployeeManagementController implements Initializable {
    ...
    private void displayReport(String title, ReportGenerator reportGenerator) {
        // Create a new window with a TextArea to display the report
        // This method would create a dialog to show the report
        // Since we don't actually modify the EmployeeDisplay methods to return strings,
        // we'll just show an alert that the report would be generated

        showAlert("Report Generation", "The " + title + " would be displayed here.\n\n" +
                "In a complete implementation, we would need to modify the EmployeeDisplay methods " +
                "to return strings instead of printing to the console.");
    }
